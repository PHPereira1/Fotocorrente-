...
num_QB_left  = 7		!Number of well/barrier of the Bragg mirror
L_qw_left    = 12.4d0 	!Width of lateral quantum well [nm]
L_qb_left    = 9.4d0 	!Width of quantum barrier [nm]

! central quantum well
L_cqw        = 16.2d0 	!Width of central quantum well [nm]

! quantum bragg mirror to right of central quantum well
num_QB_right = 8 		!Number of well/barrier of the Bragg mirror
L_qw_right   = 6.6d0 	!Width of lateral quantum well [nm]
L_qb_right   = 5.3d0 	!Width of quantum barrier [nm]
...
!----------------------------------------------------------------
	...
	do i=2,n-1
		...
		am = (m(i-1) + m(i))/2.d0 ! media das massas do eletron
		aux1 = (2*am*(Ener-v(i-1)))/hbar/hbar
		ki(i-1) = cdsqrt(aux1)
		
		am = (m(i) + m(i+1))/2.d0 ! media das massas do eletron
